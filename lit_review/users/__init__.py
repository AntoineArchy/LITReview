...
La 'users' app du projet LITReview s'occupe de la gestion des interactions entre serveur/utilisateurs et
 utilisateurs/utilisateurs. Cette app est résponsable de :
    ...
    - la possibilité pour un utilisateur de suivre ou ne plus suivre un autre utilisateur ;
    - l'affichage des listes d'utilisateurs étant suivis ou suivant l'utilisateur authentifié ;
"""
